...
try {
    $stmt = $pdo->query("
        SELECT id, title, slug, body, excerpt, featured_image, created_at, views 
        FROM blog_posts 
...
<style>
    /* Your existing styles with small improvements */
    .blog-hero {
                ...
                <article class="blog-post-card">
                    ...
                    <div class="blog-post-content">
                        ...
                        <div class="blog-post-excerpt">
                            <?php 
                            $excerpt = !empty($post['excerpt']) ? $post['excerpt'] : strip_tags($post['body']);
