...
// TODO: Asigură-te că `bundle.min.css` conține TOATE stilurile.
// Această funcție poate fi păstrată pentru alte scopuri (ex. debugging)
// dar fișierele pe care le returnează NU vor fi încărcate via <link> în <head>.
...
// Obține toate fișierele CSS necesare (pentru debugging sau alte scopuri)
...
<head>
    ...
    <style>
        html { overflow-y: scroll; }   /* permanent gutter */
    </style>
    <!-- Încărcare CSS pentru toate paginile -->
    <!-- Acum se încarcă DOAR bundle.min.css -->
